...
export function SearchBar(props: Props) {
  return (
    <div className={` flex flex-col items-center justify-start w-full`}>
      <div
        className={`flex items-center justify-start w-full gap-3 px-6 py-4 text-vapormintWhite-100 ${props.solid &&
      ...
      >
        ...
        <svg
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className={`w-6 h-6 ${!props.value &&
            "scale-0"} transition-all ease-in-out cursor-pointer origin-center delay-150`}
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
