...
function TextareaInput(props) {
    ...
    return (React.createElement("div", { className: "flex flex-col items-start justify-start w-full gap-1 py-1" },
        ...
        React.createElement("textarea", { className: `w-full h-20 text-base border-b rounded-none text-vapormintWhite-100 bg-vapormintBlack-300 hover:resize-y scrollbar scrollbar-thumb-gray-900 scrollbar-track-black ${props.error
