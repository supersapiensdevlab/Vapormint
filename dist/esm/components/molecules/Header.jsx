...
export default function Header(props) {
    ...
    return (<div className="flex flex-col items-start justify-start w-full select-none bg-vapormintBlack-300">
      <div className="flex items-center w-full p-4 pl-3 ">
        <div onClick={() => router.back()} className="flex items-center justify-start w-1/4 gap-1 text-base font-bold cursor-pointer text-vapormintWhite-100">
