...
export default function Modal(props) {
    ...
    return height && width ? (<div style={{ height: height, width: width }} className={`fixed top-0 left-0 z-50 flex items-end justify-center   select-none   backdrop-blur-sm  ${animation ? "bg-vapormintBlack-300/25" : "bg-vapormintBlack-300/0"} transition-colors ease-in-out`}>
      <div className={`flex flex-col max-w-xl items-center w-full h-fit   ${animation ? "translate-y-0" : "translate-y-full"} transition-all ease-in-out`}>
