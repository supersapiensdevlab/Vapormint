    ...
    return (<div onClick={(e) => {
      ...
      {type === "solid" && (<>
          ...
          ${kind === "mint" && "   bg-vapormintMint-300 text-vapormintBlack-300"} ${kind === "info" &&
                ...
                "   bg-vapormintWhite-100 text-vapormintBlack-300 "}  absolute shadow-md z-20 transition-all ease-in-out ${animation ? "-bottom-1 -right-1" : " bottom-0  right-0"}    text-lg font-bold  p-4 rounded-lg h-full w-full  flex justify-center items-center gap-4`}>
            {children}
          </button>
      ...
      {type === "outlined" && (<>
          ...
          ${kind === "mint" &&
                ...
                " border-vapormintWhite-100 bg-vapormintBlack-300 text-vapormintWhite-100 "}  absolute shadow-md z-20 transition-all ease-in-out  ${animation ? "-bottom-1 -right-1" : " bottom-0  right-0"} text-lg font-bold  p-4 rounded-lg h-full w-full  flex justify-center items-center gap-4`}>
            {children}
          </button>
      ...
      {type === "ghost" && (<>
          ...
          ${kind === "mint" && "bg-vapormintBlack-300 text-vapormintMint-300"} ${kind === "info" && "bg-vapormintBlack-300 text-vapormintBlue-300 "}  ${kind === "luxury" &&
                ...
                "bg-vapormintBlack-300 text-vapormintWhite-100 "}  absolute shadow-md z-20 transition-all ease-in-out  ${animation ? "-bottom-1 -right-1" : " bottom-0  right-0"} text-lg font-bold  p-4 rounded-lg h-full w-full  flex justify-center items-center gap-4`}>
            {children}
          </button>
        </>)}
    </div>);
