      ...
      <div className={`flex flex-col gap-0 overflow-hidden  rounded-lg ${props.kind === "default"
        ...
        <div className="flex items-start gap-3 px-4 py-3 ">
          ...
          <div className="flex flex-col flex-grow gap-1">
            <span className={`w-full text-lg font-bold tracking-wide ${props.kind === "default"
            ? "text-vapormintBlack-300"
            : "text-vapormintWhite-100"}`}>
              {props.message}
            </span>
            {props.description && (<span className={`w-full text-sm font-medium tracking-wide  ${props.kind === "default"
