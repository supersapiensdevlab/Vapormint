...
export default function Switch(props) {
    return (React.createElement("div", { onClick: () => (props.disabled ? "" : props.onChange()), className: "p-1 cursor-pointer " },
        React.createElement("div", { className: `h-fit  w-11 ${props.disabled
            ...
            React.createElement("div", { className: `h-4 w-4  rounded-[4px] transition-all ease-in-out ${props.on
