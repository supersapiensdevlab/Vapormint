...
export default function Pill(props) {
    return (React.createElement("div", { className: "p-1 select-none" },
        React.createElement("div", { className: `flex items-center justify-start h-8 gap-1 p-1 ${props.type === "outlined"
