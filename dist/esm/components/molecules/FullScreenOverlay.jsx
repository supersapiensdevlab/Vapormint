...
export default function FullScreenOverlay(props) {
    ...
    return height && width ? (<div style={{ height: height, width: width }} className={`fixed top-0 left-0 z-50 flex flex-col items-center justify-start   select-none transition-all ease-in-out bg-vapormintBlack-200  backdrop-blur-sm  ${animation ? "translate-y-0" : "translate-y-full"} transition-all ease-in-out`}>
...
//# sourceMappingURL=FullScreenOverlay.jsx.map