...
function Pill(props) {
    return (react_1.default.createElement("div", { className: "p-1 select-none" },
        react_1.default.createElement("div", { className: `flex items-center justify-start h-8 gap-1 p-1 ${props.type === "outlined"
                            ...
                            : props.kind === "error"
                                ...
                                : props.kind === "luxury"
                                    ...
                                    : props.kind === "warning"
                                        ...
                                        : props.kind === "success" && "text-vapormintSuccess-500"} ` }, props.children)));
}
