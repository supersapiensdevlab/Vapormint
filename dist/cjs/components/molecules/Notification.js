...
function Notification(props) {
    return (react_1.default.createElement("div", { className: "w-full p-1 select-none" },
        react_1.default.createElement("div", { className: `flex flex-col gap-0 overflow-hidden  rounded-lg ${props.kind === "default"
            ...
            react_1.default.createElement("div", { className: "flex items-start gap-3 px-4 py-3 " },
                props.icon,
                react_1.default.createElement("div", { className: "flex flex-col flex-grow gap-1" },
                    react_1.default.createElement("span", { className: `w-full text-lg font-bold tracking-wide ${props.kind === "default"
                            ? "text-vapormintBlack-300"
                            : "text-vapormintWhite-100"}` }, props.message),
                    props.description && (react_1.default.createElement("span", { className: `w-full text-sm font-medium tracking-wide  ${props.kind === "default"
