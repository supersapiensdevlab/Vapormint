...
function Fab(props) {
    return (<div onClick={props.onClick} className={`flex items-center w-fit gap-2  cursor-pointer select-none  rounded-l-full ${props.size === "xsmall" ? "p-2" : props.size === "small" ? "p-3" : "p-5"}  ${props.kind === "default"
      ...
      {props.showText && (<span className={`mr-1 text-lg font-semibold`}>{props.text}</span>)}
    </div>);
}
exports.default = Fab;
